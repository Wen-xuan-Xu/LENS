...
#
# This script delegates the actual training to the ChatTS-Training submodule
# (third_party/ChatTS-Training). It DOES NOT vendor LLaMA-Factory; see
# lens/training/ for the stage-1/stage-2 launchers.
#
